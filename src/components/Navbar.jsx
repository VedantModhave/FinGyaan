...
const Navbar = ({ onLanguageChange }) => {
  ...
  return (
    <nav className={`bg-gray-800 sticky top-0 z-50 transition-all duration-300 ${isSticky ? 'bg-opacity-50' : 'bg-opacity-100'}`}>
